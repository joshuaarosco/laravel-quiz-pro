            ...
            <div class="row">
                ...
                <div class="col-md-3 sm-hidden">
                    <form action="" method="get">
                        <input type="text" class="frm-control w-100 pull-right" name="search" value="{{ Input::has('search')?Input::get('search'):'' }}" placeholder="Filter by Name, Course, Section or School Year and hit enter...">
                    </form>
                </div>
            </div>
        </div>
            ...
            <table class="table table-hover table-condensed" id="condensedTable">
                <tbody>
                    <tr>
                        ...
                        <td class="v-align-middle bold text-right" width="10%">Actions</td>
                    </tr>
...
<form method="POST" action="" id="form-personal" role="form" autocomplete="off">
    @csrf
    @include('backoffice.pages.students._components.form')
